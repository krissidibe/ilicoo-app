...
const HomeScreen = () => {
  ...
  const { data: routePassengers } = useQuery(getRoutePassengers());
    ...
    open(
      <View className="px-5 pt-2 pb-7">
        ...
        <View className="p-4 mt-4 bg-white rounded-2xl border border-gray-300">
          ...
          {trip.driver ? (
            <View className="flex-row justify-between items-center px-3 py-2 mt-5 mb-5 rounded-xl border border-gray-300">
    ...
    <View className="flex-1 bg-background">
      ...
      >
        ...
        <Animated.View
          ...
          className="absolute right-0 left-0 -bottom-7 z-40 px-5"
        >
          <TouchableOpacity
            onPress={() => {
              Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
